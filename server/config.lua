...
ip = os.getenv("DOCKER_NETWORK_GATEWAY_ENV")
...
-- MySQL
mysqlHost = os.getenv("DOCKER_NETWORK_GATEWAY_ENV")
mysqlUser = os.getenv("DATABASE_USER_ENV")
mysqlPass = os.getenv("DATABASE_PASSWORD_ENV")
mysqlDatabase = os.getenv("DATABASE_NAME_ENV")
mysqlPort = 3306
mysqlSock = ""
passwordType = "sha1"
